...
/*   Updated: 2023/03/09 21:22:25 by acostin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	load_sprites(t_all *all)
{
	all->sprites[0].texture_addr
		= sprite_loader(all, "sprites/block_.xpm");
	all->sprites[1].texture_addr
		= sprite_loader(all, "sprites/player_.xpm");
	all->sprites[2].texture_addr
		= sprite_loader(all, "sprites/sand_.xpm");
	all->sprites[3].texture_addr
		= sprite_loader(all, "sprites/exit_.xpm");
	all->sprites[4].texture_addr
		= sprite_loader(all, "sprites/collectible_.xpm");
	return (0);
}
